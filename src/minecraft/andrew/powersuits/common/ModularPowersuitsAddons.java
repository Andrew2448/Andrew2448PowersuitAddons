...
@Mod(modid = "powersuitAddons", name = "Andrew's Modular Powersuits Addons", version = "0.1.1-1", dependencies = "required-after:mmmPowersuits", acceptedMinecraftVersions = "[1.4.7,)")
