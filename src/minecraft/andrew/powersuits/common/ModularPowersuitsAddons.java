...
@Mod(modid = "AndrewPowersuitAddons", name = "Andrew's Modular Powersuits Addons", version = "0.1.1-4", dependencies = "required-after:mmmPowersuits", acceptedMinecraftVersions = "[1.5,)")
