...
@Mod(modid = "PowersuitAddons", name = "Andrew's Modular Powersuits Addons", version = "0.1.1-5", dependencies = "required-after:mmmPowersuits", acceptedMinecraftVersions = "[1.5,)")
